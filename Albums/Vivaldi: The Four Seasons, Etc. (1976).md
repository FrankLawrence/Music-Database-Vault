---
tags: Album
banner: "![[Vivaldi: The Four Seasons, Etc. (1976).jpg]]"
---
[Year:: 1976]
[Artist:: [[Henryk Szeryng: English Chamber Orchestra]]]
```dataview
TABLE FROM [[Vivaldi: The Four Seasons, Etc. (1976)]]
```
```dataviewjs
const calendarData = {
  colors: {
...
const albumSongs = dv.pages('"Songs"')
  .where(p => p.Album && p.Album.path && p.Album.path.includes("Vivaldi: The Four Seasons, Etc. (1976)"))
  .map(p => {
